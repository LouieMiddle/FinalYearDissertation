...
\declaration{Applying Gaussian Processes in Cricket}{Louie Middle}
\newpage
...
This approach can work well for datasets with high levels of redundancy, but also introduces the problem of choosing the subset.
...
\citet{Lui2020} proposed a similar method with a tighter ELBO.
