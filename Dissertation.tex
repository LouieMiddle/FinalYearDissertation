...
TODO: Need to talk about how mean function is zero and why....

\begin{figure}[H]
   	 \begin{minipage}[t]{0.45\textwidth}
	 	\includegraphics[width=\linewidth]{RBF_sigma_1_lengthscale_1.png}
	    	\caption{SE kernel with sigma=1 and length-scale=1 \citep{Kaiser2016}}
	    	\label{fig:SEKernSig1Length1}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.45\textwidth}
	 	\includegraphics[width=\linewidth]{RBF_sigma_1_lengthscale_025.png}
	    	\caption{SE kernel with sigma=1 and length-scale=0.25 \citep{Kaiser2016}}
