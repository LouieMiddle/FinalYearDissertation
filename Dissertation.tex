...
\footnotetext{In cricket, a yorker is a delivery which hits the cricket pitch around the batsman's feet.}
\footnotetext{In cricket, a full toss is a delivery which does not pitch before it reaches the batsman.}
\footnotetext{In cricket, a half volley is a delivery which hits the cricket pitch ahead of a good length, but before the batsman's feet.}
